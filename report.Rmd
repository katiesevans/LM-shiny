...
# >> This (below) is also in linkagemapping::load_cross_obj("N2xCB4856cross_full")
load("~/Dropbox/AndersenLab/RCode/Linkage mapping/RIAILsMappings/RIAIL_data/N2xCB4856cross_full2.Rda") 

# load eQTL data from Andersen Lab Dropbox
eqtlmap <- data.table::fread("~/Dropbox/AndersenLab/RCode/Linkage mapping/eQTLmapping/eqtlmap.tsv")
load("~/Dropbox/AndersenLab/RCode/Linkage mapping/eQTLmapping/all_probe_info.Rda")
